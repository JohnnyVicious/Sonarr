...
namespace NzbDrone.Core.Parser
{
    ...
    public class ParsingService : IParsingService
    {
        ...
        private List<Episode> GetMultiSeasonEpisodes(ParsedEpisodeInfo parsedEpisodeInfo, Series series, bool sceneSource)
        {
            ...
            foreach (var seasonNum in parsedEpisodeInfo.SeasonNumbers)
            {
                ...
                if (series.UseSceneNumbering && sceneSource)
                {
                    var sceneEpisodes = _episodeService.GetEpisodesBySceneSeason(series.Id, seasonNum);
            ...
            return allEpisodes.DistinctBy(e => e.Id).ToList();
        }
